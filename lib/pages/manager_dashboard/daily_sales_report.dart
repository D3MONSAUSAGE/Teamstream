...
class DailySalesReportsPageState extends State<DailySalesReportsPage>
  ...
  Widget _buildOrderChart(List<Map<String, dynamic>> salesData) {
    return Card(
      elevation: 2,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
      child: Padding(
              ...
              child: SfCartesianChart(
                ...
                series: <CartesianSeries>[
                  ColumnSeries<Map<String, dynamic>, DateTime>(
                    ...
                    xValueMapper: (data, _) => DateTime.parse(data['date']),
                    yValueMapper: (data, _) =>
                        data['order_count'] as double? ?? 0.0,
                    name: 'Order Count',
                    color: Colors.purple,
                  ),
                  ColumnSeries<Map<String, dynamic>, DateTime>(
                    ...
                    xValueMapper: (data, _) => DateTime.parse(data['date']),
                    yValueMapper: (data, _) =>
                        data['avg_order_value'] as double? ?? 0.0,
        ...
        child: Column(
          ...
          children: [
            ...
            SingleChildScrollView(
              ...
              child: DataTable(
                columnSpacing: 8, // Reduced spacing to fit more columns
                headingRowColor:
                ...
                columns: [
                  DataColumn(
                    label: ConstrainedBox(
                      constraints:
                          const BoxConstraints(maxWidth: 60), // Constrain width
                      child: Text(
                        'Date',
                        style: GoogleFonts.poppins(
                            fontWeight: FontWeight.w600,
